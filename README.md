...
## Part I
  1. Run the container image `fosfordevops/csvgenerator:latest` in background and check if it's running.
...
> **NOTE**: One should be able to follow the instructions from the `solution/README.md` file and get csvgenerator running on their machine.
